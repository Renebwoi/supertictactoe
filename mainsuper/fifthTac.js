...
//  state = 0
 ...
 fifthdisplayValue = (i) => {
     ...
     if (state == 0) {
         ...
         state++;
         document.querySelector('.tinyTab5p1').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p1').textContent = "O";
         document.querySelector('.tab5p1').onclick = "sleep()"
     }}
     //end for first box
     ...
     if (state == 0) {
         ...
         fifthplayCount++;
         state++;
         document.querySelector('.tinyTab5p2').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p2').textContent = "O";
         document.querySelector('.tab5p2').onclick = "sleep()"
     }}
     //end for fifth box
     ...
     if (state == 0) {
         ...
         state++;
         document.querySelector('.tinyTab5p3').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p3').textContent = "O";
         document.querySelector('.tab5p3').onclick = "sleep()"
     }}
     //end for fifth box
     ...
     if (state == 0) {
         ...
         fifthplayCount++;
         state++;
         document.querySelector('.tinyTab5p4').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p4').textContent = "O";
         document.querySelector('.tab5p4').onclick = "sleep()"
     }}
     //end for fourth box
     ...
     if (state == 0) {
         ...
         fifthplayCount++;
         state++;
         document.querySelector('.tinyTab5p5').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p5').textContent = "O";
         document.querySelector('.tab5p5').onclick = "sleep()"
     }}
     //fifth box end
     ...
     if (state == 0) {
         ...
         fifthplayCount++;
         state++;
         document.querySelector('.tinyTab5p6').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p6').textContent = "O";
         document.querySelector('.tab5p6').onclick = "sleep()"
     }}
     //sixth box end
     ...
     if (state == 0) {
         ...
         fifthplayCount++;
         state++;
         document.querySelector('.tinyTab5p7').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p7').textContent = "O";
         document.querySelector('.tab5p7').onclick = "sleep()"
     }}
     //seventh box end
     ...
     if (state == 0) {
         ...
         fifthplayCount++;
         state++;
         document.querySelector('.tinyTab5p8').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p8').textContent = "O";
         document.querySelector('.tab5p8').onclick = "sleep()"
     }}
     //eight box end
     ...
     if (state == 0) {
         ...
         fifthplayCount++;
         state++;
         document.querySelector('.tinyTab5p9').textContent = "X";
         ...
         fifthplayCount++;
         state--;
         document.querySelector('.tinyTab5p9').textContent = "O";
         document.querySelector('.tab5p9').onclick = "sleep()"
     }}
     //ninth box end
 ...
 fifthcheckWin = () => {
     ...
     //fifth row
         ...
         fifthgameArray[3] == 1 ){
         document.querySelector('.fifthTacresult').innerHTML = `X wins by the second row `
         fifthTacdone = true;
         TacBlock(5, 1);
         // document.querySelector('.fifthTacresult').style.display = "flex";
     }
             ...
             fifthgameArray[3] == 2 ){
             document.querySelector('.fifthTacresult').innerHTML = `O wins by the second row `
             fifthTacdone = true;
             TacBlock(5, 0);
             // document.querySelector('.fifthTacresult').style.display = "flex";
         }
     ...
     //fifth row
         ...
         fifthgameArray[6] == 1 ){
         document.querySelector('.fifthTacresult').innerHTML = `X wins by the third row `
         fifthTacdone = true;
         TacBlock(5, 1);
         // document.querySelector('.fifthTacresult').style.display = "flex";
     }
             ...
             fifthgameArray[6] == 2 ){
             document.querySelector('.fifthTacresult').innerHTML = `O wins by the third row `
             fifthTacdone = true;
             TacBlock(5, 0);
             // document.querySelector('.fifthTacresult').style.display = "flex";
         }
     ...
     //fifth column
         ...
         fifthgameArray[1] == 1 ){
         document.querySelector('.fifthTacresult').innerHTML = `X wins by the second column `
         fifthTacdone = true;
         TacBlock(5, 1);
         // document.querySelector('.fifthTacresult').style.display = "flex";
     }
         //fifth column
             ...
             fifthgameArray[1] == 2 ){
             document.querySelector('.fifthTacresult').innerHTML = `O wins by the second column `
             fifthTacdone = true;
             TacBlock(5, 0);
             // document.querySelector('.fifthTacresult').style.display = "flex";
         }
     ...
     //fifth column
         ...
         fifthgameArray[2] == 1 ){
         document.querySelector('.fifthTacresult').innerHTML =  `X wins by the third column `
         fifthTacdone = true;
         TacBlock(5, 1);
         // document.querySelector('.fifthTacresult').style.display = "flex";
     }
         //fifth column
             ...
             fifthgameArray[2] == 2 ){
             document.querySelector('.fifthTacresult').innerHTML = `O wins by the third column `
             fifthTacdone = true;
             TacBlock(5, 0);
             // document.querySelector('.fifthTacresult').style.display = "flex";
         }
