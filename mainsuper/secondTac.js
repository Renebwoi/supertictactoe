...
//  state = 0
 ...
 seconddisplayValue = (i) => {
     ...
     if (state == 0) {
         ...
         state++;
         document.querySelector('.tinyTab2p1').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p1').textContent = "O";
         document.querySelector('.tab2p1').onclick = "sleep()"
     }}
     //end for first box
     ...
     if (state == 0) {
         ...
         secondplayCount++;
         state++;
         document.querySelector('.tinyTab2p2').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p2').textContent = "O";
         document.querySelector('.tab2p2').onclick = "sleep()"
     }}
     //end for second box
     ...
     if (state == 0) {
         ...
         state++;
         document.querySelector('.tinyTab2p3').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p3').textContent = "O";
         document.querySelector('.tab2p3').onclick = "sleep()"
     }}
     //end for third box
     ...
     if (state == 0) {
         ...
         secondplayCount++;
         state++;
         document.querySelector('.tinyTab2p4').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p4').textContent = "O";
         document.querySelector('.tab2p4').onclick = "sleep()"
     }}
     //end for fourth box
     ...
     if (state == 0) {
         ...
         secondplayCount++;
         state++;
         document.querySelector('.tinyTab2p5').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p5').textContent = "O";
         document.querySelector('.tab2p5').onclick = "sleep()"
     }}
     //fifth box end
     ...
     if (state == 0) {
         ...
         secondplayCount++;
         state++;
         document.querySelector('.tinyTab2p6').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p6').textContent = "O";
         document.querySelector('.tab2p6').onclick = "sleep()"
     }}
     //sixth box end
     ...
     if (state == 0) {
         ...
         secondplayCount++;
         state++;
         document.querySelector('.tinyTab2p7').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p7').textContent = "O";
         document.querySelector('.tab2p7').onclick = "sleep()"
     }}
     //seventh box end
     ...
     if (state == 0) {
         ...
         secondplayCount++;
         state++;
         document.querySelector('.tinyTab2p8').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p8').textContent = "O";
         document.querySelector('.tab2p8').onclick = "sleep()"
     }}
     //eight box end
     ...
     if (state == 0) {
         ...
         secondplayCount++;
         state++;
         document.querySelector('.tinyTab2p9').textContent = "X";
         ...
         secondplayCount++;
         state--;
         document.querySelector('.tinyTab2p9').textContent = "O";
         document.querySelector('.tab2p9').onclick = "sleep()"
     }}
     //ninth box end
